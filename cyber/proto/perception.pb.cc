...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fperception_2eproto = {
  false, false, descriptor_table_protodef_cyber_2fproto_2fperception_2eproto, "cyber/proto/perception.proto", 181,
...
static bool dynamic_init_dummy_cyber_2fproto_2fperception_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_cyber_2fproto_2fperception_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
