...
class RoleAttributes PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_proto_desc();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_proto_desc(
...
inline std::string* SocketAddr::unsafe_arena_release_ip() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.cyber.proto.SocketAddr.ip)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return ip_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SocketAddr::unsafe_arena_set_allocated_ip(
    std::string* ip) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (ip != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  ip_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ip, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.cyber.proto.SocketAddr.ip)
}
...
inline std::string* RoleAttributes::unsafe_arena_release_host_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.cyber.proto.RoleAttributes.host_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return host_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RoleAttributes::unsafe_arena_set_allocated_host_name(
    std::string* host_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (host_name != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  host_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      host_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.cyber.proto.RoleAttributes.host_name)
}
...
inline std::string* RoleAttributes::unsafe_arena_release_host_ip() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.cyber.proto.RoleAttributes.host_ip)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return host_ip_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RoleAttributes::unsafe_arena_set_allocated_host_ip(
    std::string* host_ip) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (host_ip != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  host_ip_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      host_ip, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.cyber.proto.RoleAttributes.host_ip)
}
...
inline std::string* RoleAttributes::unsafe_arena_release_node_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.cyber.proto.RoleAttributes.node_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000004u;
  return node_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RoleAttributes::unsafe_arena_set_allocated_node_name(
    std::string* node_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (node_name != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  ...
  node_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      node_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.cyber.proto.RoleAttributes.node_name)
}
...
inline std::string* RoleAttributes::unsafe_arena_release_channel_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.cyber.proto.RoleAttributes.channel_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000008u;
  return channel_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RoleAttributes::unsafe_arena_set_allocated_channel_name(
    std::string* channel_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (channel_name != nullptr) {
    _has_bits_[0] |= 0x00000008u;
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.cyber.proto.RoleAttributes.channel_name)
}
...
inline std::string* RoleAttributes::unsafe_arena_release_message_type() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.cyber.proto.RoleAttributes.message_type)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000010u;
  return message_type_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RoleAttributes::unsafe_arena_set_allocated_message_type(
    std::string* message_type) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (message_type != nullptr) {
    _has_bits_[0] |= 0x00000010u;
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.cyber.proto.RoleAttributes.message_type)
}
...
inline void RoleAttributes::clear_proto_desc() {
  proto_desc_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void RoleAttributes::_internal_set_proto_desc(const std::string& value) {
  _has_bits_[0] |= 0x00000020u;
  proto_desc_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void RoleAttributes::set_proto_desc(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000020u;
  proto_desc_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void RoleAttributes::set_proto_desc(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000020u;
  proto_desc_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* RoleAttributes::_internal_mutable_proto_desc() {
  _has_bits_[0] |= 0x00000020u;
  return proto_desc_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* RoleAttributes::unsafe_arena_release_proto_desc() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.cyber.proto.RoleAttributes.proto_desc)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000020u;
  return proto_desc_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RoleAttributes::unsafe_arena_set_allocated_proto_desc(
    std::string* proto_desc) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (proto_desc != nullptr) {
    _has_bits_[0] |= 0x00000020u;
  ...
  proto_desc_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      proto_desc, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.cyber.proto.RoleAttributes.proto_desc)
}
...
inline ::apollo::cyber::proto::SocketAddr* RoleAttributes::release_socket_addr() {
  auto temp = unsafe_arena_release_socket_addr();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline std::string* RoleAttributes::unsafe_arena_release_service_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:apollo.cyber.proto.RoleAttributes.service_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000040u;
  return service_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RoleAttributes::unsafe_arena_set_allocated_service_name(
    std::string* service_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (service_name != nullptr) {
    _has_bits_[0] |= 0x00000040u;
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:apollo.cyber.proto.RoleAttributes.service_name)
}
