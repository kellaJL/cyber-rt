...
ChoreographyConf::ChoreographyConf(const ChoreographyConf& from)
  ...
  if (from._internal_has_choreography_affinity()) {
    choreography_affinity_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_choreography_affinity(),
      GetArena());
  }
  ...
  if (from._internal_has_choreography_processor_policy()) {
    choreography_processor_policy_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_choreography_processor_policy(),
      GetArena());
  }
  ...
  if (from._internal_has_choreography_cpuset()) {
    choreography_cpuset_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_choreography_cpuset(),
      GetArena());
  }
  ...
  if (from._internal_has_pool_affinity()) {
    pool_affinity_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_pool_affinity(),
      GetArena());
  }
  ...
  if (from._internal_has_pool_processor_policy()) {
    pool_processor_policy_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_pool_processor_policy(),
      GetArena());
  }
  ...
  if (from._internal_has_pool_cpuset()) {
    pool_cpuset_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_pool_cpuset(),
      GetArena());
  }
