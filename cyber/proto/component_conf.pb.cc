...
ComponentConfig::ComponentConfig(const ComponentConfig& from)
  ...
  if (from._internal_has_config_file_path()) {
    config_file_path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_config_file_path(),
      GetArena());
  }
  ...
  if (from._internal_has_flag_file_path()) {
    flag_file_path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_flag_file_path(),
      GetArena());
  }
