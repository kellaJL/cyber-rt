...
SchedGroup::SchedGroup(const SchedGroup& from)
  ...
  if (from._internal_has_name()) {
    name_.Set(&::apollo::cyber::proto::SchedGroup::_i_give_permission_to_break_this_code_default_name_.get(), from._internal_name(),
      GetArena());
  }
  affinity_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_affinity()) {
    affinity_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_affinity(),
      GetArena());
  }
  cpuset_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from._internal_has_cpuset()) {
    cpuset_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_cpuset(),
      GetArena());
  }
  ...
  if (from._internal_has_processor_policy()) {
    processor_policy_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_processor_policy(),
      GetArena());
  }
...
void SchedGroup::InternalSwap(SchedGroup* other) {
  ...
  name_.Swap(&other->name_, &::apollo::cyber::proto::SchedGroup::_i_give_permission_to_break_this_code_default_name_.get(), GetArena());
